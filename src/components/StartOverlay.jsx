  ...
  return (
    <div className="absolute inset-0 z-20 flex flex-col items-center justify-center animate-fade-in">
      <div className="text-center text-white p-8">
        <h1 className="text-5xl md:text-7xl font-serif font-bold mb-2 text-shadow-lg">UNTUK KAMU</h1>
        <p className="text-xl md:text-2xl font-sans text-gray-300 mb-10">Maaf ya kalau jelek.</p>
        <button
          onClick={onStart}
